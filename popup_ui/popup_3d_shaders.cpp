...
#  if __has_include("vs_popup_model.bin.h") && __has_include("fs_popup_model.bin.h")
#    include "vs_popup_model.bin.h"
#    include "fs_popup_model.bin.h"
#    define GRIM_HAS_POPUP_EMBEDDED_SHADERS 1
#  else
#    define GRIM_HAS_POPUP_EMBEDDED_SHADERS 0
#  endif
#else
#  define GRIM_HAS_POPUP_EMBEDDED_SHADERS 0
#endif

#if GRIM_HAS_POPUP_EMBEDDED_SHADERS
...
PopupShaderState* popupShadersCreate()
{
    ...
    throw std::runtime_error(
        "popupShadersCreate: generated shader headers are missing. Build bgfx shaderc and re-run CMake so vs_popup_model.bin.h/fs_popup_model.bin.h are generated.");
#else
