# ============================================================
# Install local Windows public key into Anvil authorized_keys
...
Write-Host "Installing public key on $HostAlias ..." -ForegroundColor Cyan
Write-Host "If prompted, enter your Anvil password once so the key can be installed." -ForegroundColor Yellow
...
Write-Host "`nDone. Test with: ssh $HostAlias" -ForegroundColor Green
