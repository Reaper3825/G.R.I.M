...
$configPath = Join-Path $GrimRoot "resources\models\GRIM-text\training\config_optimized_3080ti.json"
...
$headerPath = Join-Path $GrimRoot "resources\models\GRIM-text\grim_embedding_training.hpp"
