...
private:
    ...
    void saveGeometryDraft();
    void updateOutliner(const InputState& input);
    void drawOutliner(OverlayRenderer& renderer) const;
    ...
    std::shared_ptr<UIButton> new_area_btn_;
