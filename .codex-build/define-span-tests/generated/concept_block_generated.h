...
struct ConceptBlock FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::String *define() const {
    return GetPointer<const ::flatbuffers::String *>(VT_DEFINE);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_DEFINE) &&
           verifier.VerifyString(define()) &&
           verifier.EndTable();
  }
};
...
struct ConceptBlockBuilder {
  ...
  void add_define(::flatbuffers::Offset<::flatbuffers::String> define) {
    fbb_.AddOffset(ConceptBlock::VT_DEFINE, define);
  }
...
inline ::flatbuffers::Offset<ConceptBlock> CreateConceptBlock(
    ...
    ::flatbuffers::Offset<::flatbuffers::String> define = 0) {
  ConceptBlockBuilder builder_(_fbb);
  builder_.add_timestamp(timestamp);
  builder_.add_define(define);
...
inline ::flatbuffers::Offset<ConceptBlock> CreateConceptBlockDirect(
  ...
  auto define__ = define ? _fbb.CreateString(define) : 0;
