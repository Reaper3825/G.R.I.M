 ...
 * 
 * last_obs[31] holds the most recent raw observation for ALL metric streams.
 ...
 * Streams 27-30 (PBM positional bias diagnostics).
...
struct TelemetryContext {
    ...
    float last_obs[31] = {};  // All metric streams — rho slots persist between diagnostic intervals
