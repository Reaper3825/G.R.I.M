 ...
 * 
 * last_obs[27] holds the most recent raw observation for ALL metric streams.
...
struct TelemetryContext {
    ...
    float last_obs[27] = {};  // All metric streams — rho slots persist between diagnostic intervals
