 ...
 * 
 * last_obs[47] holds the most recent raw observation for ALL metric streams (0-46 inclusive).
...
struct TelemetryContext {
    ...
    float last_obs[47] = {};  // All metric streams (0-46 inclusive) — rho slots persist between diagnostic intervals
