...
void assembleGpuModel(const ::GRIM::Config::AiConfigSnapshot& model_cfg, ::GRIM::TrainingState& training_state, const ::GRIM::PBM::PBMStateOwner& pbm_owner, GpuModelState& gpu_model_state, ::ParameterRegistry::StartupParameterRegistry& parameter_registry, std::uint64_t weight_init_seed, const ModelRegistration::OutputUnigramPriorView* output_unigram_prior);
