...
//  into TrainingState::d_class_weights for use by AutogradLoss.
//
...
// upload them to TrainingState::d_class_weights.
//
// Side effects:
//   - cudaMallocs ts.d_class_weights ([vocab_size] floats)
//   - cudaMemcpyAsync's the host weight table to that buffer
...
//   ts          - training state receiving d_class_weights
