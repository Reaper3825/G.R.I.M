...
std::unique_ptr<TrainingContext> executePhase1(int argc, char** argv) {
    ...
    ctx->telemetry.config.num_streams = 45; // 0-4: core, 5-8: rho, 9-13: adam, 14-20: exec block, 21-26: EB/SB injection, 27-30: PBM, 31-34: rho raw, 35-37: RMS gamma, 38: rho rms-spread, 39-44: h↔W alignment
