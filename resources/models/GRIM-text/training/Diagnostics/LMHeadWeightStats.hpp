...
//  that computes EXACT statistics over every vocab row of W.
//
//  Per row v ∈ [0, vocab_size):
//      row_rms[v] = sqrt( (1/d_model) · Σ_d W[v,d]² )
//
...
// Computes exact per-row RMS aggregates over the full LM-head weight matrix.
//
// Args:
