// FlatBuffers C++ output for GRIM transformer checkpoints. Source: grim_transformer_model.fbs
// Regenerate: flatc --cpp --gen-object-api -o training/schemas training/schemas/grim_transformer_model.fbs
// (ExecutionBlockWeights v2 must match Serialization_GPU.cu / grim_model_serialization.cu.)
...
struct ExecutionBlockWeights FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_B_VALUE_TO_EMB_DATA = 34,
    VT_W_INJECT_GATE_DATA = 36,
    VT_W_Q_READ_DATA = 38,
    VT_W_K_READ_DATA = 40,
    VT_W_V_READ_DATA = 42,
    VT_W_O_READ_DATA = 44,
    VT_W_GATE_READ_DATA = 46,
    VT_TAU_DATA = 48,
    VT_E_SLOT_DATA = 50,
    VT_E_OP_DATA = 52,
    VT_W_SCAL_DATA = 54,
  ...
  const ::flatbuffers::Vector<float> *w_key_proj_data() const { return GetPointer<const ::flatbuffers::Vector<float> *>(VT_W_KEY_PROJ_DATA); }
  ...
  const ::flatbuffers::Vector<float> *b_value_to_emb_data() const { return GetPointer<const ::flatbuffers::Vector<float> *>(VT_B_VALUE_TO_EMB_DATA); }
  const ::flatbuffers::Vector<float> *w_inject_gate_data() const { return GetPointer<const ::flatbuffers::Vector<float> *>(VT_W_INJECT_GATE_DATA); }
  ...
  const ::flatbuffers::Vector<float> *e_slot_data() const { return GetPointer<const ::flatbuffers::Vector<float> *>(VT_E_SLOT_DATA); }
  const ::flatbuffers::Vector<float> *e_op_data() const { return GetPointer<const ::flatbuffers::Vector<float> *>(VT_E_OP_DATA); }
  const ::flatbuffers::Vector<float> *w_scal_data() const { return GetPointer<const ::flatbuffers::Vector<float> *>(VT_W_SCAL_DATA); }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_W_KEY_PROJ_DATA) && verifier.VerifyVector(w_key_proj_data()) &&
           ...
           VerifyOffset(verifier, VT_B_VALUE_TO_EMB_DATA) && verifier.VerifyVector(b_value_to_emb_data()) &&
           VerifyOffset(verifier, VT_W_INJECT_GATE_DATA) && verifier.VerifyVector(w_inject_gate_data()) &&
           ...
           VerifyOffset(verifier, VT_E_SLOT_DATA) && verifier.VerifyVector(e_slot_data()) &&
           VerifyOffset(verifier, VT_E_OP_DATA) && verifier.VerifyVector(e_op_data()) &&
           VerifyOffset(verifier, VT_W_SCAL_DATA) && verifier.VerifyVector(w_scal_data()) &&
...
struct ExecutionBlockWeightsBuilder {
  ...
  void add_w_key_proj_data(::flatbuffers::Offset<::flatbuffers::Vector<float>> v) { fbb_.AddOffset(ExecutionBlockWeights::VT_W_KEY_PROJ_DATA, v); }
  ...
  void add_b_value_to_emb_data(::flatbuffers::Offset<::flatbuffers::Vector<float>> v) { fbb_.AddOffset(ExecutionBlockWeights::VT_B_VALUE_TO_EMB_DATA, v); }
  void add_w_inject_gate_data(::flatbuffers::Offset<::flatbuffers::Vector<float>> v) { fbb_.AddOffset(ExecutionBlockWeights::VT_W_INJECT_GATE_DATA, v); }
  ...
  void add_e_slot_data(::flatbuffers::Offset<::flatbuffers::Vector<float>> v) { fbb_.AddOffset(ExecutionBlockWeights::VT_E_SLOT_DATA, v); }
  void add_e_op_data(::flatbuffers::Offset<::flatbuffers::Vector<float>> v) { fbb_.AddOffset(ExecutionBlockWeights::VT_E_OP_DATA, v); }
  void add_w_scal_data(::flatbuffers::Offset<::flatbuffers::Vector<float>> v) { fbb_.AddOffset(ExecutionBlockWeights::VT_W_SCAL_DATA, v); }
