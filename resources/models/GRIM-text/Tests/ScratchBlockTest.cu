...
bool testIntegerEmbeddingVariance(std::string& message) {
    ...
    auto tok12 = atom_table.registerAtom(AtomType::ATOM_INT, AtomValue(int12), "12");
    auto tok731 = atom_table.registerAtom(AtomType::ATOM_INT, AtomValue(int731), "731");
    auto tok_neg = atom_table.registerAtom(AtomType::ATOM_INT, AtomValue(int_neg), "-42");
...
bool testAtomSemanticReasoning(std::string& message) {
    ...
    auto tok_small_int = atom_table.registerAtom(AtomType::ATOM_INT, AtomValue(small_int), "5");
    auto tok_large_int = atom_table.registerAtom(AtomType::ATOM_INT, AtomValue(large_int), "5000");
...
bool testRoundTripEncoding_FULL(std::string& message) {
    ...
    SB_ASSERT_TRUE(atom_counts[AtomType::ATOM_INT] > 0, "Should detect email");
    SB_ASSERT_TRUE(atom_counts[AtomType::ATOM_INT] > 0, "Should detect URL");
    SB_ASSERT_TRUE(atom_counts[AtomType::ATOM_INT] > 0, "Should detect integers");
