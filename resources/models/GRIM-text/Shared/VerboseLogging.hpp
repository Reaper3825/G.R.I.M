...
constexpr bool ENABLE_GPU_ALLOCATION_LOGS = true;     ///< [GPU_ALLOC] allocation request diagnostics
...
constexpr bool ENABLE_FA_EQUATION_DIAGNOSTICS = true;  ///< [FA-FWD-*], [ATTN_SCORE_EQUATION]
