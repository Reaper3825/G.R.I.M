...
#include "../Gradients/GradientCC_GPU.hpp"
...
struct OptimizerState {
    ...
    // ClipScratch RAII destructor when OptimizerState is destroyed.
    std::unique_ptr<GradClip::ClipScratch> gradient_clip_scratch;
