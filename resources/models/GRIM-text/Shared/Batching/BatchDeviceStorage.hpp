...
struct BatchDeviceStorage {
    ...
    Tensor number_aux_target_atom_index_tensor;  // int32 [1, max_tokens]
    Tensor number_aux_target_row_mask_tensor;    // uint8 [max_tokens]
    Tensor number_aux_target_step_index_tensor;  // int32 [1, max_tokens]
