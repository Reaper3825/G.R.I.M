...
// kernel_gelu_forward moved to GeluGradFn.cu

// kernel_rmsnorm_forward + kernel_rmsnorm_backward moved to RMSNormGradFn.cu

// kernel_embedding_forward and kernel_embedding_backward moved to EmbeddingGradFn.cu

// kernel_log_softmax_forward + kernel_log_softmax_backward moved to LogSoftmaxGradFn.cu
// kernel_softmax_forward + kernel_softmax_backward moved to SoftmaxGradFn.cu

// kernel_concat_forward + kernel_concat_backward_a + kernel_concat_backward_b moved to ConcatGradFn.cu
...
// LayerScaleGradFn moved to LayerScaleGradFn.hpp / LayerScaleGradFn.cu

// CenterRowsGradFn moved to CenterRowsGradFn.hpp / CenterRowsGradFn.cu

// CenterColumnsGradFn moved to CenterColumnsGradFn.hpp / CenterColumnsGradFn.cu

// ProjectOutPC1GradFn (and PC1 projection kernels) moved to ProjectOutPC1GradFn.hpp / ProjectOutPC1GradFn.cu

// AddGradFn moved to AddGradFn.hpp / AddGradFn.cu

// BiasAddGradFn (and its biasAddKernel/biasBackwardKernel/launchBiasAdd/launchBiasBackward
// helpers) moved to BiasAddGradFn.hpp / BiasAddGradFn.cu

// GeluGradFn moved to GeluGradFn.hpp / GeluGradFn.cu

// SiluGradFn moved to SiluGradFn.hpp / SiluGradFn.cu

// ExpGradFn moved to ExpGradFn.hpp / ExpGradFn.cu
// AddScalarGradFn moved to AddScalarGradFn.hpp / AddScalarGradFn.cu
// ReciprocalGradFn moved to ReciprocalGradFn.hpp / ReciprocalGradFn.cu
// MulScalarGradFn moved to MulScalarGradFn.hpp / MulScalarGradFn.cu

// BroadcastRowMulGradFn moved to BroadcastRowMulGradFn.hpp / BroadcastRowMulGradFn.cu

// ZeroPadGradFn moved to ZeroPadGradFn.hpp / ZeroPadGradFn.cu

// ElementwiseMulGradFn moved to ElementwiseMulGradFn.hpp / ElementwiseMulGradFn.cu

// RMSNormGradFn moved to RMSNormGradFn.hpp / RMSNormGradFn.cu

// EmbeddingGradFn moved to EmbeddingGradFn.hpp / EmbeddingGradFn.cu
...
// autograd::add(...) moved to AddGradFn.cu

// ScaleScalarGradFn moved to ScaleScalarGradFn.hpp / ScaleScalarGradFn.cu

// autograd::scale_scalar(...) moved to ScaleScalarGradFn.cu

// autograd::broadcast_add(...) moved to BiasAddGradFn.cu
 ...
 */
// autograd::gelu(...) moved to GeluGradFn.cu
 ...
 */
// autograd::silu(...) moved to SiluGradFn.cu
 ...
 */
// autograd::exp(...) moved to ExpGradFn.cu
 ...
 */
// autograd::add_scalar(...) moved to AddScalarGradFn.cu
 ...
 */
// autograd::reciprocal(...) moved to ReciprocalGradFn.cu
 ...
 */
// autograd::mul_scalar(...) moved to MulScalarGradFn.cu

// autograd::broadcast_row_mul(...) moved to BroadcastRowMulGradFn.cu
 ...
 */
// autograd::zero_pad(...) moved to ZeroPadGradFn.cu

// autograd::elementwise_mul(...) moved to ElementwiseMulGradFn.cu

// autograd::rms_norm(...) moved to RMSNormGradFn.cu
...
// autograd::embedding(...) moved to EmbeddingGradFn.cu
...
// autograd::layer_scale(...) moved to LayerScaleGradFn.cu

// autograd::center_rows(...) moved to CenterRowsGradFn.cu

// autograd::center_columns(...) moved to CenterColumnsGradFn.cu

// autograd::project_out_pc1(...) moved to ProjectOutPC1GradFn.cu

// SoftmaxGradFn moved to SoftmaxGradFn.hpp / SoftmaxGradFn.cu
// autograd::softmax(...) moved to SoftmaxGradFn.cu
// ConcatGradFn moved to ConcatGradFn.hpp / ConcatGradFn.cu
// autograd::concat(...) moved to ConcatGradFn.cu

// CrossEntropyLogitsGradFn (and CE logits kernels) moved to CrossEntropyLogitsGradFn.hpp / CrossEntropyLogitsGradFn.cu
// autograd::cross_entropy_logits(...) moved to CrossEntropyLogitsGradFn.cu
