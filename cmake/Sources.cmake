...
file(GLOB VOICE_SOURCES CONFIGURE_DEPENDS "voice/*.cpp")
file(GLOB VOICE_HEADERS CONFIGURE_DEPENDS "voice/*.hpp")
if(APPLE)
...
file(GLOB bootstrap_SOURCES CONFIGURE_DEPENDS "bootstrap/*.cpp")
file(GLOB bootstrap_HEADERS CONFIGURE_DEPENDS "bootstrap/*.hpp")
...
file(GLOB core_HEADERS CONFIGURE_DEPENDS "core/*.hpp")
file(GLOB input_SOURCES CONFIGURE_DEPENDS "core/input/*.cpp")
file(GLOB input_HEADERS CONFIGURE_DEPENDS "core/input/*.hpp")
...
file(GLOB_RECURSE PERCEPTION_SOURCES CONFIGURE_DEPENDS "perception/*.cpp")
file(GLOB_RECURSE PERCEPTION_HEADERS CONFIGURE_DEPENDS "perception/*.hpp")
...
file(GLOB DataCollection_SOURCES CONFIGURE_DEPENDS "DataCollection/*.cpp")
file(GLOB DataCollection_HEADERS CONFIGURE_DEPENDS "DataCollection/*.hpp")
