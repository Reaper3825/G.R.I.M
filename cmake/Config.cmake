...
if(GRIM_USE_PERCEPTION)
    ...
    find_package(OpenCV QUIET COMPONENTS core imgproc dnn imgcodecs)
 ...
 if(Leptonica_FOUND)
  ...
  message(STATUS "[GRIM] ✓ Perception models fully available")
        ...
        message(STATUS "[GRIM] Install missing packages with: vcpkg install opencv[dnn,contrib] tesseract leptonica")
  endif()
else()
